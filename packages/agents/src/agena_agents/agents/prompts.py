...
REFINEMENT_SYSTEM_PROMPT = (
    ...
    '- ALWAYS suggest a story point estimate > 0 based on the title and description, even if details are sparse.\n'
    '  Use the title, work item type, and any available context to infer complexity.\n'
    '  Only use 0 if the item is completely incomprehensible.\n'
    '- Set confidence proportionally: detailed items get 70-95%, sparse items get 30-60%.\n'
